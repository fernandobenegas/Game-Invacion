...
import pygame
import random
from pygame import mixer # Modulo de sonido
pygame.init()
...
def detectarColicion(x_1,y_1,x_2,y_2):
    ...
    if distancia < 27:
        ...
        False
#Funcion de mostrarpuntaje

def mostrar_puntaje(x,y):
    texto = fuente.render(f' Puntaje {puntaje}', True ,(255,255,255,255))
    pantalla.blit(texto,(x,y)) #Arrojamos el texo
...
while corriendo:
    ...
    for e in range(cantidad_enemigos):    
        ...
        if enemigoX[e] <= 0:
            enemigo_x_cambio[e] = 0.1 # Movimientos en el eje X
